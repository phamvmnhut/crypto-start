...
export function MainAnd2ColumnBlog({
  mainMeta,
  latestMeta,
  hotMeta,
}: {
    ...
    <section className="px-5 py-20">
      <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
        <div className="flex flex-col justify-between col-span-12 py-2 space-y-8 md:space-y-16 md:col-span-3">
          ...
          <div className="flex flex-col w-full space-y-2">
            ...
            >
              ...
              <MoveRight className="text-primary w-4 h-4" />
            </Link>
          </div>
        </div>
        <div
          className="rounded-lg relative flex col-span-12 bg-center bg-no-repeat bg-cover dark:bg-gray-500 xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-[20rem] overflow-clip"
          style={{
        ...
        >
          ...
          <div className="flex flex-col items-center justify-end group flex-grow-1">
            <div className=" h-fit  p-6 text-center sm:p-8  w-full bg-gradient-to-t from-black to-transparent ">
              <Link href={`/posts/${mainMeta.id}`}>
                <h1 className="text-2xl font-semibold group-hover: bg-gray-500/50 rounded-md text-white px-3 py-2">
                  {mainMeta.title}
                </h1>
        ...
        <div className="col-span-12 py-2 xl:col-span-3 lg:col-span-4">
          <div className="mb-5 space-x-5 border-b-2 border-opacity-80 border-primary">
            <div className="pb-2 font-bold border-primary">Mới nhất</div>
          </div>
  ...
  return (
    <div className="flex px-1 py-4">
      ...
      <div className="flex flex-col flex-grow">
        <Link href={`/posts/${meta.id}`} className="">
          <h2>{meta.title}</h2>
        </Link>
        <p className="mt-auto text-xs dark:text-gray-400">{meta.date}</p>
      </div>
    </div>
  );
}
